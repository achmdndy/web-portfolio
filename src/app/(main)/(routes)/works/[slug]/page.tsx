...
export async function generateMetadata({ params }: WorksSlugProps): Promise<Metadata> {
    ...
    <Section>
      <article className="aurora-container aurora-px-4 aurora-max-w-[70ch] aurora-py-8">
        ...
        <nav className="aurora-flex aurora-items-center aurora-gap-2 aurora-text-sm aurora-text-gray-500 dark:aurora-text-gray-400 aurora-mb-6">
          <a href="/works" className="hover:aurora-text-primary aurora-transition-colors">
            Works
          </a>
          <span>/</span>
          <span className="aurora-text-gray-700 dark:aurora-text-gray-200">{work.title}</span>
        </nav>

        {/* Header Section */}
        <header className="aurora-mb-8">
          <h1 className="aurora-text-3xl aurora-font-bold aurora-mb-4">{work.title}</h1>
        ...
        <div className="aurora-grid aurora-grid-cols-1 md:aurora-grid-cols-3 aurora-gap-8 aurora-mb-12">
          <div className="aurora-col-span-2">
            ...
            <section className="aurora-space-y-4">
              <h2 className="aurora-text-2xl aurora-font-semibold">Tentang Proyek</h2>
            ...
            <section className="aurora-mt-8">
              <h2 className="aurora-text-2xl aurora-font-semibold aurora-mb-4">Fitur Utama</h2>
              <ul className="aurora-space-y-3">
                {work.features.map((feature, index) => (
                  <li key={index} className="aurora-flex aurora-items-start aurora-gap-2">
          ...
          <aside className="aurora-space-y-8">
            {/* Technologies */}
            <section>
              <h3 className="aurora-text-lg aurora-font-semibold aurora-mb-3">Teknologi</h3>
            ...
            {/* Timeline */}
            <section>
              <h3 className="aurora-text-lg aurora-font-semibold aurora-mb-3">Periode</h3>
            ...
            {/* Links */}
            <section>
              <h3 className="aurora-text-lg aurora-font-semibold aurora-mb-3">Tautan</h3>
